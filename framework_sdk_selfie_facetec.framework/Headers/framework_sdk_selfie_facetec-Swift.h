...
#ifndef FRAMEWORK_SDK_SELFIE_FACETEC_SWIFT_H
#define FRAMEWORK_SDK_SELFIE_FACETEC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="framework_sdk_selfie_facetec",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC28framework_sdk_selfie_facetec22CapturaSViewController")
...
- (nonnull instancetype)initWithChave:(NSString * _Nonnull)chave wizard:(BOOL)wizard segurancaExtraRootCheck:(BOOL)segurancaExtraRootCheck segurancaExtraSslPinning:(BOOL)segurancaExtraSslPinning tipoRetorno:(NSString * _Nonnull)tipoRetorno customizacaoTexto:(ConfiguracaoTextoSelfie * _Nonnull)customizacaoTexto retornarErros:(BOOL)retornarErros segurancaExtraEmulatorCheck:(BOOL)segurancaExtraEmulatorCheck OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_PROTOCOL("_TtP28framework_sdk_selfie_facetec30CapturaSViewControllerDelegate_")
@protocol CapturaSViewControllerDelegate
...
SWIFT_CLASS("_TtC28framework_sdk_selfie_facetec28CapturarSelfieViewController")
...
@interface CapturarSelfieViewController (SWIFT_EXTENSION(framework_sdk_selfie_facetec)) <AVCaptureVideoDataOutputSampleBufferDelegate>
@end


SWIFT_CLASS("_TtC28framework_sdk_selfie_facetec23ConfiguracaoTextoSelfie")
...
SWIFT_CLASS("_TtC28framework_sdk_selfie_facetec21OvalGraficOverlayView")
...
SWIFT_CLASS("_TtC28framework_sdk_selfie_facetec11SelfieModel")
...
@interface UIButton (SWIFT_EXTENSION(framework_sdk_selfie_facetec))
